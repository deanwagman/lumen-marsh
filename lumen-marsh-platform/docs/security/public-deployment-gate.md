...
- [ ] Store Environmental Monitor client secret in Secrets Manager / SSM
- [ ] Configure API `VENUEOPS_SECURITY_MODE=OIDC`, issuer, `VENUEOPS_ALLOWED_CLIENT_IDS` (console client, then monitor when enabled)
- [ ] Configure console Cognito client id, domain/authority, exact callback + logout URLs
- [ ] Deploy API, console, and monitor with non-LOCAL_JWT credentials
