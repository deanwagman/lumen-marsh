  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'Park Flow Intelligence never changes attraction status or capacity. Repeat the story with ./scripts/park-flow-demo.sh after the stack is up, and reset with ./scripts/reset-demo.sh --confirm.',
      ],
    },
    {
      id: 'retention',
